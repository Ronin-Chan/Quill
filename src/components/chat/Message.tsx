  ...
  return (
    <div
      ...
      <div className={cn('relative flex h-6 w-6 aspect-square items-center justify-center', {
        "order-2 bg-yellow-400 rounded-sm": message.isUserMessage,
        "order-1 bg-zinc-800 rounded-sm": !message.isUserMessage,
        invisible: isNextMsgSamePerson
      })}>
        {message.isUserMessage ? (
          <Icons.user className='fill-white h-3/4 w-3/4 text-white' />
        ) : (
      ...
      <div className={cn(
        ...
        <div className={cn('px-4 py-4 rounded-lg inline-block', {
          'bg-yellow-400 text-white': message.isUserMessage,
